...
// attempted to refactor, got confused when it came to veryfying the tokens and passport stuff...
...
router.get('/profile', passport.authenticate('jwt', { session: false }), async (req : Request, res : Response) => {
  try{
     res.json({
